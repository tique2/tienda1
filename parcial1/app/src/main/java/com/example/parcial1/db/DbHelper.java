...
public class DbHelper extends SQLiteOpenHelper {
    ...
    @Override
    public void onCreate(SQLiteDatabase dbproductos) {
        dbproductos.execSQL("create table "+DATAVASE_TABLE_login+"(" +
                "id integer primary key autoincrement," +
                "usuario text not null," +
                "Password text not null)");
        dbproductos.execSQL("create table "+DATAVASE_TABLE_productos+"(" +
                "id integer primary key autoincrement," +
    ...
    public void onGuardar(SQLiteDatabase guardar){
        ...
        guardar.execSQL("UPDATE "+DATAVASE_TABLE_productos);
    }
    @Override
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int i, int i1) {
        sqLiteDatabase.execSQL("drop table "+DATAVASE_TABLE_login);
        sqLiteDatabase.execSQL("drop table "+DATAVASE_TABLE_productos);
